; Modified for the exercise 5 task of algo and data
#lang r7rs
...
;-*-*              2018 - 2022 Software Languages Lab                 *-*-
...
(define-library (file-system)
  (export format! new-block delete-block delete-chain!
          ...
          mk ls rm whereis df label label!) ; MODIFIED
  (import (scheme base)
  ...
  (begin
    ...
    (define label-offset (+ available-offset disk:block-ptr-size)) ; ADDED
